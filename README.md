...
> macOS正式版：1.1.0，使用Developer ID签名并通过Apple公证。Windows x64的1.0.0候选版已通过GitHub Windows虚拟机的编译、完整测试、安装、卸载和旧版升级验证；正式安装包仍在等待SignPath.io与SignPath Foundation可信签名，当前公开下载版为0.3.2预览版。
