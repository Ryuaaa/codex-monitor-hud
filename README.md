...
> macOS正式版：1.0.2，已完成Developer ID签名和Apple公证。Windows x64的1.0.0候选版已通过GitHub Windows虚拟机的编译、完整测试、安装、卸载和旧版升级验证；正式安装包仍在等待SignPath.io与SignPath Foundation可信签名，当前公开下载版为0.3.2预览版。
...
- [Windows 0.3.2预览版](https://github.com/Ryuaaa/codex-monitor-hud/releases/tag/windows-v0.3.2)：可下载未签名的测试安装包和便携包。Windows 1.0.0正式安装包会在可信签名完成后发布。
