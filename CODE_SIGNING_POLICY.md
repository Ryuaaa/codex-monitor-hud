...
See the project [privacy policy](PRIVACY.md). The program transfers information
only for features specifically requested or enabled by the user, such as
reading Codex account data through the locally installed official Codex
interface, reading OpenAI's public service-status endpoint, and checking this
repository's public GitHub Releases for updates. It does not upload performance
history, conversation content, prompts, account tokens, cookies, or API keys.
